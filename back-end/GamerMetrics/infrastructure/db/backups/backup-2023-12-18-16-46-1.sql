...
1	admin@admin	admin	f	admin	admin	$2a$10$VoacR3WfhnNgUrDeexuBJ.Tn7zi0EOkUDqxwWOi.ncWUT7yEoHrrO	ADMIN	\N	\N	\N
\.
...
2	f	f	eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiQURNSU4iLCJzdWIiOiJhZG1pbkBhZG1pbiIsImlhdCI6MTcwMjkxMDI3OCwiZXhwIjoxNzAyOTk2Njc4fQ.HwMhnXnWXhYaR9f877_8Th7MzZhC0zj1sKQnEmowqI0	Bearer	1
\.
...
SELECT pg_catalog.setval('public.metrics_seq', 1, false);
...
SELECT pg_catalog.setval('public.user_play_seq', 1, false);
